<%@ include file="header.jsp" %>
	...
	<sec:authorize access="hasRole('ROLE_USER')">
		<c:url var="url" value="./userRendicontUpload?" />
		<c:url var="urlCancellaForm" value="./userCancellaRendiconFile" />
	 </sec:authorize>	
	 <sec:authorize access="hasRole('ROLE_ADMIN')">
	 	<c:url var="url" value="/adminRendicontUpload?" />
	 	<c:url var="urlCancellaForm" value="/adminCancellaRendiconFile" />
	 </sec:authorize>
<div id="contenitore">
	<div id="formDivInputFile">
	  ...
	  <div id="tabellaFile">
	  <c:choose>
	  	 <c:when test="${not empty listaFileRendicontazione}">
				<div>
				<table id="table_id" class="display">
					...
					<tbody>
							<c:forEach var="listValue" items="${listaFileRendicontazione}">
							  <tr>
  ...
  <form:form action="${urlCancellaForm}" method="POST" modelAttribute="rendicontazioneBean" id="cancellaFile" >
